...
let attractionsMarkers = [{
        location: {
            lat: -33.856543821752794,
            lng: 151.21527524045297
        },
        content: "<h6>Sydney Opera House</h6>"
    },
    {
        location: {
            lat: -33.8520746192094,
            lng: 151.2107870981232
        },
        content: "<h6>Sydney Harbour Bridge</h6>"
    },
    {
        location: {
            lat: -33.87084698630033,
            lng: 151.20909379812386
        },
        content: "<h6>Sydney Tower Eye</h6>"
    }
];

let barsclubsMarkers = [{
        location: {
            lat: -33.87003959244973,
            lng: 151.2051437269588
        },
        content: "<h6>Catina OK</h6>"
    },
    {
        location: {
            lat: -33.86832748834104,
            lng: 151.2048179134643
        },
        content: "<h6>PS40</h6>"
    },
    {
        location: {
            lat: -33.86710113454278,
            lng: 151.19558052695868
        },
...
let hotelsMarkers = [{
        location: {
            lat: -33.868516113790704,
            lng: 151.22040862695886
        },
        content: "<h6>Ovolo Woolloomooloo</h6>"
    },
    {
        location: {
            lat: -33.86532426380766,
            lng: 151.2051743711346
        },
        content: "<h6>Little National Hotel Sydney</h6>"
    },
    {
        location: {
            lat: -33.872457090332645,
            lng: 151.19710524229967
        },
...
let restaurantsMarkers = [{
        location: {
            lat: -33.85722877121859,
            lng: 151.21035336928813
        },
        content: "<h6>Quay</h6>"
    },
    {
        location: {
            lat: -33.886254831374224,
            lng: 151.22991487113518
        },
        content: "<h6>Saint Peter</h6>"
    },
    {
        location: {
            lat: -33.88908454294458,
            lng: 151.1654055435762
        },
